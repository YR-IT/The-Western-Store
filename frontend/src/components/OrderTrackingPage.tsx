    ...
    >
      <div className="max-w-4xl mx-auto px-3 sm:px-6 w-full">
        ...
        >
          ...
          {/* Quick Demo Orders Pill Bar */}
          <div className="mt-6 pt-5 border-t border-[#F3EFE6]">
            <p className="text-[11px] font-semibold uppercase tracking-wider text-[#8C8276] mb-2.5">
              Quick Test Orders (Click any sample to test status tracking):
            </p>
            <div className="flex flex-wrap gap-2">
              <button
                type="button"
                onClick={() => {
                  setOrderIdInput('TWS-2026-1001');
                  setPhoneInput('9812345678');
                  performSearch('TWS-2026-1001', '9812345678');
                }}
                className="px-2.5 py-1 bg-[#F4EFE6] hover:bg-[#EAE4D9] text-[#242120] border border-[#D9CEBF] rounded-xs text-xs transition-colors flex items-center gap-1.5"
              >
                <span className="w-1.5 h-1.5 rounded-full bg-purple-500" />
                <span className="font-mono text-[11px]">TWS-2026-1001</span>
                <span className="text-[10px] text-purple-700 font-medium">(Shipped / Delhivery)</span>
              </button>

              <button
                type="button"
                onClick={() => {
                  setOrderIdInput('TWS-2026-1002');
                  setPhoneInput('9416023451');
                  performSearch('TWS-2026-1002', '9416023451');
                }}
                className="px-2.5 py-1 bg-[#F4EFE6] hover:bg-[#EAE4D9] text-[#242120] border border-[#D9CEBF] rounded-xs text-xs transition-colors flex items-center gap-1.5"
              >
                <span className="w-1.5 h-1.5 rounded-full bg-blue-500" />
                <span className="font-mono text-[11px]">TWS-2026-1002</span>
                <span className="text-[10px] text-blue-700 font-medium">(Confirmed at Store)</span>
              </button>

              <button
                type="button"
                onClick={() => {
                  setOrderIdInput('TWS-2026-1004');
                  setPhoneInput('9896011223');
                  performSearch('TWS-2026-1004', '9896011223');
                }}
                className="px-2.5 py-1 bg-[#F4EFE6] hover:bg-[#EAE4D9] text-[#242120] border border-[#D9CEBF] rounded-xs text-xs transition-colors flex items-center gap-1.5"
              >
                <span className="w-1.5 h-1.5 rounded-full bg-emerald-600" />
                <span className="font-mono text-[11px]">TWS-2026-1004</span>
              ...
              <button
                type="button"
                onClick={() => {
                  setOrderIdInput('TWS-2026-1003');
                  setPhoneInput('9991200344');
                  performSearch('TWS-2026-1003', '9991200344');
                }}
                className="px-2.5 py-1 bg-[#F4EFE6] hover:bg-[#EAE4D9] text-[#242120] border border-[#D9CEBF] rounded-xs text-xs transition-colors flex items-center gap-1.5"
              >
                <span className="w-1.5 h-1.5 rounded-full bg-amber-500" />
                <span className="font-mono text-[11px]">TWS-2026-1003</span>
                <span className="text-[10px] text-amber-700 font-medium">(Pending WhatsApp)</span>
              </button>
            </div>
          </div>
        </div>
