...
export const CartDrawer: React.FC = () => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex justify-end">
      ...
      {/* Drawer */}
      <div className="relative w-full max-w-md bg-[#FDFBF7] h-full shadow-2xl z-10 flex flex-col justify-between border-l border-[#EAE4D9] animate-in slide-in-from-right duration-300">
        {/* Header */}
        <div className="p-5 border-b border-[#EAE4D9] flex items-center justify-between bg-[#F8F5EE]">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs text-[#721B29] font-semibold bg-[#721B29]/10 px-2 py-0.5 rounded-full">
              {cart.length}
            </span>
          </div>
          <button
            type="button"
            onClick={() => setIsCartOpen(false)}
            className="p-1 text-[#4A453E] hover:text-[#721B29] rounded-full hover:bg-white"
          >
            <X className="w-5 h-5" />
          </button>
        </div>
          ...
          {cart.length === 0 ? (
            <div className="py-16 text-center">
              ...
              <button
                ...
                className="mt-5 px-5 py-2.5 bg-[#721B29] text-white text-xs font-semibold rounded-xs shadow-xs hover:bg-[#852031] transition-colors"
              >
                Start Shopping
              </button>
            </div>
                  ...
                  <div>
                    <div className="flex items-start justify-between gap-2">
                      ...
                      <button
                        ...
                        className="text-[#998F82] hover:text-[#721B29] transition-colors p-0.5"
                        title="Remove"
                      >
                  ...
                  <div className="mt-3 flex items-center justify-between">
                    ...
                    <div className="flex items-center border border-[#D9CEBF] rounded-xs bg-white text-xs">
                      <button
                        ...
                        className="px-2 py-0.5 text-[#4A453E] hover:bg-[#F3EFE6]"
                      >
                        −
                      </button>
        ...
        {cart.length > 0 && (
          <div className="p-5 border-t border-[#EAE4D9] bg-[#FAF8F3] space-y-3">
            ...
            <button
              ...
              className="w-full py-3.5 bg-gradient-to-r from-emerald-700 to-emerald-800 hover:from-emerald-800 hover:to-emerald-900 text-white font-semibold text-xs sm:text-sm rounded-sm shadow-md transition-all flex items-center justify-center gap-2 cursor-pointer"
            >
