                                ...
                                {hasTracking ? (
                                  <div className="space-y-1.5 min-w-[200px]">
                                    <div className="flex items-center justify-between">
                                      ...
                                      <button
                                        type="button"
                                        onClick={() => handleOpenTrackingModal(order)}
                                        className="text-[10px] text-[#721B29] font-semibold hover:underline cursor-pointer"
                                      >
                                        Edit
                                      </button>
                                    </div>
                                  ...
                                  <div>
                                    <button
                                      type="button"
                                      onClick={() => handleOpenTrackingModal(order)}
                                      className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-amber-50 hover:bg-amber-100 text-amber-900 border border-amber-300 rounded-sm font-semibold text-[11px] transition-colors cursor-pointer"
                                    >
                                      <Plus className="w-3.5 h-3.5 text-amber-700" />
                                      <span>Add Tracking Link & AWB</span>
                                    </button>
                                    <p className="text-[10px] text-[#8C8276] mt-1">
                                      Not yet dispatched
                                    </p>
                                  </div>
                                )}
